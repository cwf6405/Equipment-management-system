<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="photo-check-em.aspx.cs" Inherits="EMS201724112106.photo_check_em" %>
        ...
        <div class="row">
          ...
          <div class="card">
           <div class=" card-header  bg-success text-white" style="height:80px;">
              ...
              <div class="body1">
                  <div style="text-align:center;"><h2>设备图片查看</h2></div>
                  <br />
                  名字：
