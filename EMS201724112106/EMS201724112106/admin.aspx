<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="EMS201724112106.admin" %>
          ...
          <div class="card">
           <div class=" card-header  bg-success text-white" style="height:80px;">
              <table style="text-align:center;margin:30px; margin-left:80px; margin-top:10px;">
                  <tr>
                      <td style="width:200px;font-size:large;">欢迎您！<asp:Label ID="Label2" runat="server" ForeColor="#0066FF"></asp:Label></td>
              ...
              <div style="text-align:center; background-color:lightgrey; margin-bottom:4px;">
                  <div class=" btn-group">
                      <asp:Button ID="Button1" runat="server" Text="图片上传 " CssClass="btn btn-success" OnClick="Button1_Click" />
                      <asp:Button ID="Button2" runat="server" Text="查看设备图片" CssClass="btn btn-success" OnClick="Button2_Click" /></div>
                      <br />
                      <br />   
